...
\hline \\[-1.8ex] 
\multicolumn{5}{l}{\parbox[t]{\textwidth}{{\textit{Notes:}} Cross-classified random effects (CCRE) logistic regression model with fixed 2-year lag. Cross-classifed andom intercepts include firm and year. Measure of board-member partisanship: \textit{party-cycle}, which may vary across election cycles. }} \\
