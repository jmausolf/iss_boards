...
g2
finalise_plot(g2, "", "output/plots/party_match_by_cycle.png",
              footer=FALSE, width_pixels=640, height_pixels=450)
```



```{r boardparty_by_cycle}
...
g1
finalise_plot(g1, "", "output/plots/party_match_by_board_party_cycle.png",
              footer=FALSE, width_pixels=640, height_pixels=450)
...
```{r boardparty_by_cycle_combined}
...
```{r board party by cycle margins}
...
g <- ggplot(df_var_cycle_graph, aes(make_datetime(year), proportion_em)) +
    geom_smooth(aes(color=event), alpha=0.15, size=0.5, method = "glm") +
    geom_line(aes(color=event), alpha=0.9)  +
    facet_grid(event~board_party, labeller = as_labeller(grid_types)) +
...
g
finalise_plot(g, "", "output/plots/party_match_by_board_party_cycle.png",
              footer=FALSE, width_pixels=640, height_pixels=450)
